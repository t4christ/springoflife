...
class CornerManager(models.Manager):
    def active(self, *args, **kwargs):
        # Post.objects.all() = super(PostManager, self).all()
        return super(CornerManager, self).filter(draft=False)
...
class Post(models.Model):
    ...
    if settings.DEBUG:
        ...
        content_image = models.ImageField(upload_to=settings.POST_URL, 
            null=True, 
            blank=True, 
            max_length=10000,
            width_field="width_field", 
        ...
        image = models.ImageField(upload_to=settings.MEDIA_URL, 
            ...
            width_field="width_field", 
            height_field="height_field")
        content_image = models.ImageField(upload_to=settings.MEDIA_URL, 
            null=True, 
            blank=True, 
            max_length=10000,
            width_field="width_field", 
